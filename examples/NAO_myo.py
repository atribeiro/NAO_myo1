...
class Listener(myo.DeviceListener):
	...
	text = open("pose.txt", "a")
	text.write("\n{}" .format(pose))
    def on_orientation_data(self, myo, timestamp, orientation):
		text = open("orientation.txt", "a")
		text.write("\n{}" .format(orientation))
		print_('orientation', orientation)
		
    def on_accelerometor_data(self, myo, timestamp, acceleration):
		text = open("acceleration.txt", "a")
		text.write("\n{}".format(acceleration))
		print_('acceleration', acceleration)
		
    def on_gyroscope_data(self, myo, timestamp, gyroscope):
		text = open("gyroscope.txt", "a")
		text.write("\n{}" .format(gyroscope))
		print_('gyroscope', gyroscope)
